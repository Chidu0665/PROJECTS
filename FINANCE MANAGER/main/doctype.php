...
<div id="log">
<a href="index.php">Home</a> | <a href="categories.php">Type of Transaction</a> | Mode of Transaction | <a href="../index.php">Logout</a>
</div>
<div id="formdesign">
<input type="text" name="filter" value="" id="filter" placeholder="Search Transaction Mode..." autocomplete="off" />
<a rel="facebox" href="adddoc.php" id="add"> Add Mode</a>
</div>
