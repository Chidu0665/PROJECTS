...
<div id="log">
<a href="index.php">Home</a> | Type Of Transaction | <a href="doctype.php">Mode Of Transaction</a> | <a href="../index.php">Logout</a>
</div>
<div id="formdesign">
<input type="text" name="filter" value="" id="filter" placeholder="Search Transaction Type..." autocomplete="off" />
<a rel="facebox" href="addtype.php" id="add">Add Type</a>
</div>
...
<tbody>
	...
	<tr class="record">
		...
		<td><a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete The Category">Delete</a></td>
	</tr>
	<?php
		}
	?>
...
//Built a url to send
var info = 'id=' + del_id;
 if(confirm("Are you sure you want to delete this Mode? There is NO undo!"))
		  {
